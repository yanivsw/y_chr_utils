y_chr_dataset = {
    'Chagyrskaya2' : ['Chagyrskaya2',            'Neandertal',  ['hg19']],
    'Mezmaiskaya2' : ['Mezmaiskaya2\n~43 kya',   'Neandertal',  ['hg19']],               # 44965 – 42156 [IntCal20]   43449
    'A00_I10871'   : ['A00 (Shum Laka)\n~8 kya', 'African',     ['hg19', 'A0b', 'T2T']], # 8008-7839  [IntCal20]      7913
    ...
    'Loschbour'    : ['I2 (Loschbour)\n~8 kya',  'non-African', ['hg19']],               # 8171-7936   [IntCal20]     8025
    ...
    'Ust_Ishim'    : ['K (Ust\'Ishim)\n~44 kya', 'non-African', ['hg19']],               # 45930-42904 [IntCal20]     44366
    'HGDP00549'    : ['M1',                      'non-African', ['hg19', 'A0b', 'T2T']],
    'Yana1'        : ['P1 (Yana1)\n~32 kya',     'non-African', ['hg19']],               # 32200 - 31532 [IntCal20]   31850
