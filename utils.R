...
tree_metadata = data.frame(label = c(# Neandertals
                                    #  'Chagyrskaya2', 'Mezmaiskaya2, ~43 ka',
                                     'Chagyrskaya2, ~80 ka', 'Mezmaiskaya2, ~43 ka',
                                     # Africans
                                     ...
                                     'I2a2a1a2a2', 'O1b1a1a1a', 'O2a2b1a1a', 'Q1a2a1a1', 'R2a', 'R1a1a1b2', 'R1b1a2a1a2b',
                                     'K (Ust\'Ishim, ~44 ka)', 'P1 (Yana1, ~32 ka)', 'I2 (Loschbour, ~8 ka)'),
                           group = c(rep("Neandertal", 2), rep("African", 14), rep("non-African", 19)))
...
fix_tree_labels <- function(tr) {
    ...
    tr$tip.label[tr$tip.label=='HGDP01075'] = 'R1b1a2a1a2b'
